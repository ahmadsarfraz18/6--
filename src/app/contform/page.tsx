...
const ContactForm = () => {
    return (
        <div className="mt-6 max-w-6xl max-lg:max-w-3xl mx-auto bg-gradient-to-r from-cyan-400 to-sky-100 rounded-3xl py-4 shadow-xl shadow-black">
            <div className="grid lg:grid-cols-2 items-center gap-14 sm:p-8 p-4 font-[sans-serif]">
                <div>
                    <h1 className="text-4xl font-serif text-slate-200">Get in Touch</h1>
                    <br />
                    <p className="text-sm text-slate-200 font-serif mt-4 leading-relaxed">
                    ...
                    <ul className="mt-12 space-y-8">
                        <li className="flex items-center">
                            ...
                            <a href="mailto:saadq77109@gmail.com" className="text-white font-serif text-sm ml-4">
                                saadq77109@gmail.com
                            </a>
                        </li>
                        <li className="flex items-center">
                            ...
                            <a href="tel:+923200276011" className="text-white font-serif text-sm ml-4">
                                03200276011
                            </a>
                        </li>
                        <li className="flex items-center">
                            ...
                            <a href="https://maps.google.com/?q=Your+Location" className="text-white font-serif text-sm ml-4">
                                House#3 sadat manzil soldier bazar no1 karachi Pakistan
                            </a>
                        </li>
                    </ul>
                </div>
                ...
                <form className="space-y-4">
                    ...
                    <br />
                    <br />
                    <button type="submit" className="bg-gradient-to-r from-sky-100 to-slate-900 shadow-2xl shadow-black text-black font-normal py-2 px-4 rounded-md hover:bg-black hover:text-white duration-200">
                        Send Message
                    </button>
                </form>
            </div>
